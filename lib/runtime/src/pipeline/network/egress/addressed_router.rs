            ...
            'evt: loop {
                let res = tokio::select! {
                    _ = engine_ctx.stopped() => {
                        ...
                        // handled by the "stream ended unexpectedly" branch below.
